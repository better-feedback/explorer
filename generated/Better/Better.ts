...
export class Better__bountiesResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class Better__getBountyResultValue0Struct extends ethereum.Tuple {
  ...
  get fulfillments(): Array<Better__getBountyResultValue0FulfillmentsStruct> {
    return this[7].toTupleArray<
      Better__getBountyResultValue0FulfillmentsStruct
    >();
  }

  get contributions(): Array<Better__getBountyResultValue0ContributionsStruct> {
    return this[8].toTupleArray<
      Better__getBountyResultValue0ContributionsStruct
    >();
  }
}

export class Better__getBountyResultValue0FulfillmentsStruct extends ethereum.Tuple {
...
export class Better__getBountyResultValue0ContributionsStruct extends ethereum.Tuple {
...
export class Better extends ethereum.SmartContract {
  static bind(address: Address): Better {
    return new Better("Better", address);
  }

  bounties(param0: BigInt): Better__bountiesResult {
    ...
    return new Better__bountiesResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_bounties(param0: BigInt): ethereum.CallResult<Better__bountiesResult> {
  ...
  getBounty(_bountyId: BigInt): Better__getBountyResultValue0Struct {
    let result = super.call(
      "getBounty",
    ...
    return result[0].toTuple() as Better__getBountyResultValue0Struct;
  }

  try_getBounty(
    _bountyId: BigInt
  ): ethereum.CallResult<Better__getBountyResultValue0Struct> {
    let result = super.tryCall(
      "getBounty",
      "getBounty(uint256):((address[],address[],uint256,address,uint256,uint256,bool,(address[],address)[],(address,uint256,bool)[]))",
      [ethereum.Value.fromUnsignedBigInt(_bountyId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as Better__getBountyResultValue0Struct
    );
  }
